...
$faq = array(
	...
	/* 給湯器・エコキュートは、こわれてから急いで探される方が多いので、
	   ここではよく聞かれる4つだけにして、
	   くわしくは「選び方」のページにご案内しています（2026/09/02 追加）。
	   同じ文章を2か所に書くと、検索で両方の評価が下がるためです。 */
	array(
		'id'    => 'boiler',
		'ttl'   => '給湯器・エコキュートのこと',
		'chara' => array( 'char-wrench.webp', 592, 640 ),
		'qa'    => array(
			array( '給湯器の寿命はどれくらいですか？',
			       'およそ10年から15年が目安です。10年を過ぎて調子が悪いときは、早めのお取り替えをおすすめします。とくに冬場は機器への負担が大きく、こわれやすい時期です。' ),
			array( '急にお湯が出なくなりました。すぐに来てもらえますか？',
			       'できるかぎり早くうかがいます。ヤマキシ給湯センターに在庫を持っている機種であれば、工期は半日です。まずはお電話かLINEで、いまの状態とリモコンに出ている数字をお知らせください。' ),
			array( 'リモコンに数字（エラーコード）が出ています。故障でしょうか？',
			       'ご自分で直せるものもあります。<a href="' . home_url( '/troubleshooting/' ) . '">エラーコード一覧</a>で、メーカーごとに原因と対処方法をご案内しています。エラーが消えないとき、水がもれているときは、お使いにならずにご連絡ください。' ),
			array( 'うちに合う機種が分かりません。どう選べばいいですか？',
			       'ガス・灯油・電気のどれをお使いかで、選べる機種が決まります。号数やタンクの大きさの選び方は、<a href="' . home_url( '/products/boiler-guide/' ) . '">給湯器・エコキュートの選び方</a>でご説明しています。' ),
		),
	),
  ...
  <div class="l-wrap l-wrap--narrow">
    <div class="p-lpcta">
      ...
      <div class="p-lpcta__btns">
        <a class="c-btn c-btn--line c-btn--block" href="https://line.me/R/ti/p/@233okcdx" rel="noopener" data-cta="faq-cta">
