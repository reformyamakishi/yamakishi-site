  ...
  <div class="l-wrap">
    <div class="p-sim" data-sim data-reveal="zoom">
      <div class="p-sim__head">
        <img class="p-sim__chara c-chara--float" src="<?php echo $asset; ?>/assets/img/character/char-search.webp" width="592" height="640" alt="" loading="lazy" decoding="async">
...
<section class="l-section" id="price">
  <div class="l-wrap">
    <div class="c-head" data-reveal>
      <img class="c-head__chara c-chara--float" src="<?php echo $asset; ?>/assets/img/character/char-otoku.webp" width="488" height="640" alt="" loading="lazy" decoding="async">
    ...
    <div class="p-price__grid">
      ...
      <?php /* 水まわり4点セットのバナーは、いちばん上の「水まわり4点パック」の
               カードと同じ中身で二重になっていたので、やめました
               （2026/09/22 ユーザー指示「水まわり4点セットが2つあります。
                 下のものは削除したはずだけど」）。
               もう一度出したくなったときは、Gitの履歴から戻せます。 */ ?>
...
<section class="l-section" id="reason">
  <div class="l-wrap">
    <div class="c-head" data-reveal>
      <img class="c-head__chara c-chara--float" src="<?php echo $asset; ?>/assets/img/character/char-hinshitsu.webp" width="592" height="640" alt="" loading="lazy" decoding="async">
...
<section class="l-section l-section--soft" id="faq">
  <div class="l-wrap">
    <div class="c-head" data-reveal>
      <img class="c-head__chara c-chara--float" src="<?php echo $asset; ?>/assets/img/character/char-peek.webp" width="640" height="411" alt="" loading="lazy" decoding="async">
...
<!-- ==========================================================
     ...
     ========================================================== -->
<?php if ( function_exists( 'ymkrf_flyer_banner' ) ) ymkrf_flyer_banner(); ?>
